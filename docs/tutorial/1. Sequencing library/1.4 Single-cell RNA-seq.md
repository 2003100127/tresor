...
<figure markdown="span">
  ![Image title](../../img/lib/sc/lib_random_content.jpg){ width="800" }
...
<figure markdown="span">
  ![Image title](../../img/lib/sc/umi.jpg){ width="800" }
...
<figure markdown="span">
  ![Image title](../../img/lib/sc/barcode.jpg){ width="800" }
...
<figure markdown="span">
  ![Image title](../../img/lib/sc/seq.jpg){ width="800" }
...
<figure markdown="span">
  ![Image title](../../img/lib/sc/seq_lib.jpg){ width="800" }
...
<figure markdown="span">
  ![Image title](../../img/lib/sc/cdna_ids.jpg){ width="800" }
